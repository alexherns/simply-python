...
class BST_Tests(unittest.TestCase):
    ...
    def test_next(self):
        ...
        for i in range(100):
            self.assertEqual(bst.find_node(i).find_next(),
                             bst.find_node(i + 1))
    ...
    def test_mrca(self):
        ...
        self.assertEqual(data_structures.BST.mrca(
            bst.left.left, bst.right), bst)
        self.assertEqual(data_structures.BST.mrca(
            bst.left.right.left, bst.right), bst)
